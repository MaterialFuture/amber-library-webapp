...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Cr Fullstack web application."
  #
  #
  ...
  #
  # settings.secret_key_base= WeGuFJWft-IwSJXQUDSIz5ZzugvS6vfYK--q6CLUDc4
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("cr_fullstack.log", "w"))
  #
  #
end
